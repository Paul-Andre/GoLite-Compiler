...
function f·3 (  ) {
	globf·1 = binary_Sub_int(globf·1,1);
}
function h·4 ( a·5 ) {
	globh·2 = binary_Sub_int(globh·2,1);
}
function i·6 (  ) {
}
function main (  ) {
	print_not_float(globf·1);
	print_not_float(" ");
	print_not_float(globh·2);
	print_not_float("\n");

	var ⴵ_1 = f·3();
	var ⴵ_3 = f·3();
	var ⴵ_2 = h·4(deepCopy(ⴵ_3), );
	print_not_float(globf·1);
	print_not_float(" ");
	print_not_float(globh·2);
	print_not_float(" ");
	...
	var ⴵ_4 = h·4(deepCopy(globf·1), );
	var ⴵ_5 = f·3();
	var ⴵ_6 = i·6();
	var ⴵ_8 = f·3();
	var ⴵ_7 = h·4(deepCopy(ⴵ_8), );
	var ⴵ_9 = h·4(deepCopy(1), );
	var ⴵ_10 = f·3();
	print_not_float(globf·1);
	print_not_float(" ");
	print_not_float(globh·2);
	print_not_float(" ");
	print_not_float(binary_Add_int(binary_Add_int(binary_Add_int(ⴵ_4,globf·1),ⴵ_5),ⴵ_6[check_bounds(binary_Sub_int(ⴵ_7,globf·1),ⴵ_6.length,37)]));
	print_not_float(" ");
	print_not_float(ⴵ_9);
	print_not_float(" ");
	print_not_float(ⴵ_10);
	print_not_float("\n");
