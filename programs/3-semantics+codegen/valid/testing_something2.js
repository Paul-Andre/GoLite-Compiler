...
function main (  ) {
	if (binary_Eq(alice·5,carol·6)) {
		print_not_float("Alice == Carol");
		print_not_float("\n");
	...
	if (binary_Eq(bob·7,bob2·8)) {
		print_not_float("Bob == Bob2");
		print_not_float("\n");
	...
	if (binary_Eq(john·9,john2·10)) {
		print_not_float("John == John2");
		print_not_float("\n");
	...
	if (binary_Eq(one·3,two·4)) {
		print_not_float("one == two");
		print_not_float("\n");
