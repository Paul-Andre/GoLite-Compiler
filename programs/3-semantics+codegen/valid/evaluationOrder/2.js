...
function main (  ) {
	print_not_float(a·1[check_bounds(0,a·1.length,22)]);
	print_not_float(" ");
	print_not_float(b·2[check_bounds(0,b·2.length,22)]);
	print_not_float(" ");
	print_not_float(prevA·4[check_bounds(0,prevA·4.length,22)]);
	print_not_float("\n");
