...
function main (  ) {
	print_not_float(a·1[check_bounds(0,a·1.length,24)]);
	print_not_float(" ");
	print_not_float(b·2[check_bounds(0,b·2.length,24)]);
	print_not_float(" ");
	print_not_float(prevA·5[check_bounds(0,prevA·5.length,24)]);
	print_not_float("\n");
