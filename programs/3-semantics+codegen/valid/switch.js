...
function f·2 (  ) {
	glob·1 = binary_Sub_int(glob·1,1);
}
function main (  ) {
	switch (true) {
		case (function() {
			return false;}()):
			print_not_float("WRONG");
			print_not_float("\n");

			break;
		default:
			print_not_float("RIGHT");
			print_not_float("\n");
	...
	switch (4) {
		case (function() {
			return 42;}()):
			print_not_float("The meaning of life and everything");
			print_not_float("\n");

			break;
		case (function() {
			return 24;}()):
			print_not_float("gnihtyreve dna efil fo gninaem ehT");
			print_not_float("\n");

			break;
		case (function() {
			return 5;}()):
			print_not_float("long");
			print_not_float("\n");
	...
	var ⴵ_1 = f·2();
	switch (binary_Add_int(glob·1,ⴵ_1)) {
		case (function() {
			var ⴵ_2 = f·2();
			return ⴵ_2;}()):
			print_not_float("gnihtyreve dna efil fo gninaem ehT");
