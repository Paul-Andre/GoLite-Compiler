...
function main (  ) {
	print_not_float(binary_Add(binary_Add(a·1,b·2),String.fromCharCode(d·3)));
	print_not_float(" ");
	print_not_float(c·4);
	print_not_float("\n");

	print_not_float(binary_Leq("h",a·1));
	print_not_float("\n");

	print_not_float(binary_Leq("i",a·1));
	print_not_float("\n");

	print_not_float(binary_Gt("alex","^lex"));
	print_not_float(" ");
	print_not_float(binary_Lt("^lex","Alex"));
	print_not_float(" ");
	print_not_float(binary_Lt("Blex","alex"));
	print_not_float(" ");
	print_not_float(binary_Leq("alex","alex"));
	print_not_float(" ");
	print_not_float(binary_Leq("alex ","alex"));
	print_not_float("\n");
