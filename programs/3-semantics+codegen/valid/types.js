...
function main (  ) {
	print_not_float(binary_Add_int(a·1,b·2));
	print_not_float("\n");

	print_not_float(binary_Mul_int(a·3,b·4));
	print_not_float("\n");

	print_not_float(binary_Div_int(a·5,b·6));
	print_not_float("\n");

	print_not_float(binary_Div_int(10,3));

	print_not_float(a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,55)].ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,55)].ㆭa.ㆭa.length,55)].ㆭa.ㆭa);
	print_not_float(" ");
	print_not_float(a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,56)].ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,56)].ㆭa.ㆭa.length,56)].ㆭa.ㆭb);
	print_not_float(" ");
	print_float(a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,57)].ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,57)].ㆭa.ㆭa.length,57)].ㆭa.ㆭc);
	print_not_float(" ");
	print_not_float(a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,58)].ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,58)].ㆭa.ㆭa.length,58)].ㆭa.ㆭd);
	print_not_float(" ");
	print_not_float(a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,59)].ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa[check_bounds(0,a·7.ㆭa.ㆭa.ㆭa.ㆭa.length,59)].ㆭa.ㆭa.length,59)].ㆭa.ㆭe);
	print_not_float("\n");

	print_not_float(a·8[check_bounds(0,a·8.length,67)]);
	print_not_float(" ");
	print_not_float(b·9[check_bounds(1,b·9.length,67)]);
	print_not_float(" ");
	print_not_float(c·10[check_bounds(1,c·10.length,67)]);
	print_not_float("\n");
