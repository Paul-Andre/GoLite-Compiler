...
function main (  ) {
	...
	print_not_float(true);
	print_not_float(false);
	print_not_float(0);
	print_not_float(2);
	print_not_float("asdf");
	print_not_float("");
	print_float(12.123);
	print_float(234.234);
	print_not_float(97);
	...
	print_not_float(39);
	print_not_float("\"");
	print_float(100000000000000.0);
	print_float(0.0000000000001);
	print_not_float("a\n'aasd'42151/.,75/,1\\254");
	...
	print_float(100.);
	print_not_float(" ");
	print_float(unary_Neg(0.01));
	print_not_float(" ");
	print_float(unary_Neg(100.));
	print_not_float("\n");
