...
function bar·5 (  ) {
	index·2 = binary_Sub_int(index·2,1);
}
function main (  ) {
	print_not_float(a·6);
	print_not_float(" ");
	...
	print_not_float("Value before print:");
	print_not_float(" ");
	...
	print_not_float("Starting index:");
	print_not_float(" ");
	print_not_float(index·2);
	print_not_float("\n");
	...
	print_not_float(index·2);
	print_not_float(" ");
	print_not_float(arr·3[check_bounds(ⴵ_3,arr·3.length,46)]);
	print_not_float(" ");
	print_not_float(index·2);
	print_not_float("\n");
