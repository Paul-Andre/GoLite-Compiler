...
function mutateParameter·4 ( s·5 ) {
}
function passGlobal·6 (  ) {
}
function main (  ) {
	print_not_float(local1·7.ㆭa);
	print_not_float(" ");
	print_not_float(local2·8.ㆭa);
	print_not_float("\n");

	print_not_float(local1·9.ㆭa);
	print_not_float(" ");
	print_not_float(local2·10.ㆭa);
	print_not_float("\n");

	var ⴵ_1 = mutateParameter·4(deepCopy(local1·11), );
	ⴵ_1;
	print_not_float(local1·11.ㆭa);
	print_not_float("\n");

	print_not_float(local1·12.ㆭa);
	print_not_float(" ");
	print_not_float(slice·13[check_bounds(0,slice·13.length,46)].ㆭa);
	print_not_float("\n");

	print_not_float(global1·2.ㆭa);
	print_not_float(" ");
	print_not_float(g·14.ㆭa);
	print_not_float("\n");
